...
<head>
	...
	<body onLoad="javascript:document.formulario.login.focus();"><center>
		...
		{	
			$_SESSION['form'] = "Aviso";
		//echo $_SESSION['securimage_code_value'] . " :: " . $HTTP_SESSION_VARS['securimage_code_value'];
		...
		if ($securimage->check($_POST[captcha_code]) == true) {  //$securimage->check($_POST[captcha_code]) == true
