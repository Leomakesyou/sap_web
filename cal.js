...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function newDatepickerHTML () {
			...
			for (var i = -1; i <= opts.endyear - opts.startyear +1; i ++) years[i] = opts.startyear + i;
			...
			jQuery("thead",table).append('<tr class="days"><th>Do</th><th>Lu</th><th>Ma</th><th>Mi</th><th>Ju</th><th>Vi</th><th>Sa</th></tr>');
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				jQuery(this).click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						jQuery("select[name=year]", datepicker).get(0).selectedIndex = Math.max(0, chosendate.getFullYear() - opts.startyear + 1);
