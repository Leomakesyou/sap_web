...
<html lang="es">
<head>
	<title>.: Web App Administraci&oacute;n :.</title>
...
<?php
	...
	{	
		...
		require_once ($gloPathPublica . "/includes/securimage/securimage.php");
		$securimage = new Securimage();
		if ($securimage->check($_POST[captcha_code]) == true) {

			include ($gloPathPublica . "/conexion/Conect_DB.php");
			...
			$link = mysql_connect($hostname_cn_MySQL, $username_cn_MySQL, $password_cn_MySQL) or trigger_error(mysql_error(),E_USER_ERROR); 
				...
				$sql .= " Where j0.login = '$login' and j0.clave = '$pass' and j0.activo='Y' and j0.admin = 'Y'";
	...
	<table width='95%' align="center" cellpadding="0" class="Tabla_Uno">
		<tr class="Tabla_Titulo">
			<td><div align="center">
				<?= "Administración <br> Ingrese Nombre de Usuario y Clave"; ?>
			</div></td>
		</tr>
		<tr class="Tabla_Encabezado">
			<td><div align="center">
			<img src="<?php echo $gloRutaPublica . "/imagenes/logo.png"; ?>" 
			width="300" height="100" alt="<?php echo $gloNombreCliente ?>"></div>
			</td>
		</tr>
